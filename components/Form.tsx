		...
		>
			...
			{!file && (
				<div
					...
					onDrop={handleDrop}
					className={`w-full ${file ? "" : "border-4"} ${
						dragging ? "border-green-300" : "border-green-500 border-dashed"
					...
					<div>
						<div className="py-4 md:py-0">
							<div className="py-4 md:py-24 text-center text-neutral-600">
								...
								<div
									className="rounded-sm bg-green-500 text-neutral-50 py-2 px-2 max-w-[200px] mx-auto cursor-pointer"
			...
			{file && (
				<>
					<div className="grid grid-cols-[20px_minmax(0,1fr)] gap-x-3">
						...
						<div
							className="mt-3 mb-10 text-neutral-500 font-normal cursor-pointer"
							onClick={() => fileElement?.current?.click()}
						>
							{file.name}
						</div>
						...
						{language ? (
							...
							>
								...
								/>
								<path
									d="M5 11.8H17.6M17.6 11.8L12.8 7M17.6 11.8L12.8 16.6"
									stroke="#EAB308"
									strokeWidth="2"
								/>
							</svg>
						...
						<div className="flex flex-col md:gap-x-3 gap-y-3 md:flex-row md:items-center text-neutral-600">
							<div>Choose target language</div>
							<select
								id="language"
								value={language}
						...
						{language && (
							<>
								...
								<div className="text-neutral-600">Complete payment</div>

								<div></div>
								<div className="text-neutral-500 mt-3 font-normal">
									We charge only $1/hour of translation, minimum charge is $1.
								</div>
